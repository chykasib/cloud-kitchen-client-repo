        ...
        path: '/', element: <Main></Main>, errorElement: <ErrorPage />, children: [
            {
                ...
                loader: () => fetch('https://cloud-server-delta.vercel.app/services')
            },
            {
                path: '/services', element: <Services></Services>,
                loader: () => fetch('https://cloud-server-delta.vercel.app/Allservices')
            },
            {
            ...
            },
            {
                ...
                loader: ({ params }) => fetch(`https://cloud-server-delta.vercel.app/services/${params.id}`)
            },
            {
